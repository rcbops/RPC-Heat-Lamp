{%- set keyname = '/etc/ssl/private/lamp' -%}
...
{{ keyname }}.pem:
  file.managed:
    - source: salt://lamp/haproxy/files/cert.pem
    - replace: False
    - mode: 600
...
/etc/haproxy/haproxy.cfg:
  file.managed:
    - source: salt://lamp/haproxy/files/haproxy.cfg
    - template: jinja
    - makedirs: True

/etc/default/haproxy:
  file.managed:
    - source: salt://lamp/haproxy/files/default-haproxy
    - makedirs: True
